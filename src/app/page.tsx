                    ...
                    >
                        <Grid container spacing={3}>
                            <Grid>
                                ...
                                >
                                    {t(
                                        "about-section.what-is-youtube-playlist-manager.title",
                                    )}
                                </Typography>
                                <Typography gutterBottom>
                                    {t(
                                        "about-section.what-is-youtube-playlist-manager.content",
                                    )}
                                </Typography>
                            </Grid>
                            ...
                            <Grid>
                                <Typography gutterBottom>
                                    <TransWithoutContext
                                        i18nKey={
                                            "about-section.disclimer.content"
                                        }
